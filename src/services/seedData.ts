...
export async function seedDatabase() {
  try {
    ...
    const piecesData = [
      ...
      { code: 'K50', etat: EtatPiece.INSTALLED, prioritaire: true, positionIndex: 0, sacIndex: 0 },
      { code: 'A1', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 1, sacIndex: 0 },
      { code: 'B23', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 2, sacIndex: 0 },

      // SAC-002 (positions 3-4)
      { code: 'K51', etat: EtatPiece.INSTALLED, prioritaire: true, positionIndex: 3, sacIndex: 1 },
      { code: 'C45', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 4, sacIndex: 1 },

      // SAC-003 (positions 5-7)
      { code: 'D12', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 5, sacIndex: 2 },
      { code: 'K52', etat: EtatPiece.INSTALLED, prioritaire: true, positionIndex: 6, sacIndex: 2 },
      { code: 'E78', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 7, sacIndex: 2 },

      // SAC-004 (positions 8-9)
      { code: 'F90', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 8, sacIndex: 3 },
      { code: 'G34', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 9, sacIndex: 3 },

      // SAC-005 (positions 10-11)
      { code: 'K53', etat: EtatPiece.INSTALLED, prioritaire: true, positionIndex: 10, sacIndex: 4 },
      { code: 'H56', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 11, sacIndex: 4 },

      // SAC-006 (positions 12-13)
      { code: 'I22', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 12, sacIndex: 5 },
      { code: 'J88', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 13, sacIndex: 5 },

      // SAC-007 (positions 14-15, puis 0)
      { code: 'K54', etat: EtatPiece.INSTALLED, prioritaire: true, positionIndex: 14, sacIndex: 6 },
      { code: 'L15', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 15, sacIndex: 6 },
      { code: 'M99', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 0, sacIndex: 6 },

      // SAC-008 (positions 1-2)
      { code: 'N44', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 1, sacIndex: 7 },
      { code: 'K55', etat: EtatPiece.INSTALLED, prioritaire: true, positionIndex: 2, sacIndex: 7 },

      // SAC-009 (positions 3-4)
      { code: 'O77', etat: EtatPiece.UNINSTALLED, prioritaire: false, positionIndex: 3, sacIndex: 8 },
      { code: 'P33', etat: EtatPiece.ONWAIT, prioritaire: false, positionIndex: 4, sacIndex: 8 },
    ];
